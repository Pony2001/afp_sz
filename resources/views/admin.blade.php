...
<div style="display: block; margin:0 auto">
    <table class="table table-striped table-dark ">
        <tr>
         ...
         <td>{{$item->phone}}</td>
         <td>
             <a href="/profile/{{$item->id}}" class="mr-3" title="Megtekint" data-toggle="tooltip"><span class="fa fa-eye"></span></a>
            <a href="/insert/{{$item->id}}" class="mr-3" title="Módosít" data-toggle="tooltip"><span class="fa fa-pencil"></span></a>
